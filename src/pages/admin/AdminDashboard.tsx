...
import { MessageSquare, DoorOpen, AlertTriangle, Users, Star } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      const [complaints, pendingComplaints, gatePasses, pendingGatePasses, emergencies, students, feedback] = await Promise.all([
